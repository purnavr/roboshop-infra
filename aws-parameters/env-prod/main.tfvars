...
#  { name  = "test", value = "hello world", type = "String" },
  { name  = "prod.frontend.catalogue_url", value = "http://catalogue-prod.roboz.in.net:80/", type = "String" },
  { name  = "prod.frontend.user_url", value = "http://user-prod.roboz.in.net:80/", type = "String" },
  { name  = "prod.frontend.cart_url", value = "http://cart-prod.roboz.in.net:80/", type = "String" },
  { name  = "prod.frontend.shipping_url", value = "http://shipping-prod.roboz.in.net:80/", type = "String" },
  { name  = "prod.frontend.payment_url", value = "http://payment-prod.roboz.in.net:80/", type = "String" },
  { name  = "prod.cart.redis_host", value = "redis-prod.roboz.in.net", type = "String" },
  { name  = "prod.cart.catalogue_host", value = "catalogue-prod.roboz.in.net", type = "String" },
  ...
  { name  = "prod.catalogue.mongo_url", value = "mongodb://mongodb-prod.roboz.in.net:27017/catalogue", type = "String" },
  { name  = "prod.user.mongo", value = "true", type = "String" },
  #{ name  = "prod.user.mongo", value = "MONGO=true", type = "String" },
  { name  = "prod.user.redis_host", value = "redis-prod.roboz.in.net", type = "String" },
  { name  = "prod.user.mongo_url", value = "mongodb://mongodb-prod.roboz.in.net:27017/users", type = "String" },
#  { name  = "prod.shipping.cart_endpoint", value = "cart-prod.roboz.online:80", type = "String" },
  ...
  { name  = "prod.shipping.db_host", value = "mysql-prod.roboz.in.net", type = "String" },
...
#  { name  = "prod.payment.user_port", value = "80", type = "String" },
  ...
  { name  = "prod.payment.ampq_host", value = "rabbitmq-prod.roboz.in.net", type = "String" },
  { name  = "prod.dispatch.ampq_host", value = "rabbitmq-prod.roboz.in.net", type = "String" },
